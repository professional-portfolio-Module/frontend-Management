  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Glassmorphism card */}
        <div className="bg-white/[0.05] backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/20">
          ...
          {/* Error Message */}
          {error && (
            <div className="mb-6 p-3.5 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center gap-3 animate-shake">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" id="login-form">
            ...
            <div className="space-y-2">
              <label htmlFor="emailOrUsername" className="block text-sm font-medium text-slate-300">
                Email or Username
              </label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  <svg className="w-5 h-5 text-slate-500 group-focus-within:text-indigo-400 transition-colors duration-200" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-white/[0.04] border border-white/[0.08] rounded-xl text-white placeholder-slate-500 text-sm
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-xs text-indigo-400 hover:text-indigo-300 transition-colors duration-200" id="forgot-password-link">
                  Forgot password?
                </a>
              </div>
              <div className="relative group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-11 pr-12 py-3 bg-white/[0.04] border border-white/[0.08] rounded-xl text-white placeholder-slate-500 text-sm
                    focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500/40 focus:bg-white/[0.06]
                    hover:border-white/[0.15] transition-all duration-200"
                />
                <button
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500
                text-white font-semibold rounded-xl shadow-lg shadow-indigo-500/20
                focus:outline-none focus:ring-2 focus:ring-indigo-500/40
                disabled:opacity-50 disabled:cursor-not-allowed
                transform active:scale-[0.98] transition-all duration-200 text-sm"
            >
              {isLoading ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              id="google-login-btn"
              className="flex items-center justify-center gap-2.5 py-2.5 px-4 bg-white/[0.04] border border-white/[0.08] rounded-xl
                text-slate-300 text-sm font-medium hover:bg-white/[0.08] hover:border-white/[0.15] transition-all duration-200"
            >
          ...
          <p className="text-center text-sm text-slate-400 mt-8">
            ...
            <a href="#" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-200" id="signup-link">
              Create account
            </a>
          </p>
        </div>
        ...
        <p className="text-center text-xs text-slate-600 mt-6">
          © 2026 Frontend Management. All rights reserved.
        </p>
      </div>
    </div>
  );
